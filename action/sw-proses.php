...
case 'login':
  ...
  if (empty($_POST['employees_code'])) { 
      ...
      $created_cookies =  md5($employees_code);
  }
...
if (empty($error)){
    ...
    $query_login ="SELECT id,employees_email,employees_name,created_cookies FROM employees WHERE employees_code='$employees_code' AND employees_password='$password'";
  ...
  if($result_login->num_rows > 0){
    ...
    echo'Nomor hp dan password yang Anda masukkan salah!';
    }
  }
